            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Donation Information Details</h4>
                            </div>
                                        ...
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                        echo '<tr>
                                                            <td align = "left">'  .  $i  .  '</td>
                                                            <td align = "left">'  .  $row['doncat']  .  '</td>
                                                            <td align = "left">'  .  $row['dondesc']  .  '</td>
                                                            <td align = "left">'  .  $row['dondesc1']  .  '</td>
                                                            <td align = "left"><img src="images/' . $row['donimage'] . '" alt="" style="width:100px; height:auto;"></td>
                                                            <td align = "left"><a href ="donationupdate.php?id='  .  $row['donid']  .  '"><i class="fa fa-pencil"></a></td>
                                                            <td align ="left"><a href ="donationdelete.php?id='  .  $row['donid']  .  '"><i class="fa fa-trash-o"></a></td>
                                                            </tr>
                                                        ';
                                                        $i++;
                                                    }
                                            ...
                                            mysqli_free_result ($result);
                                                  ...
                                                  echo '<p class = "error"> </p>';
                                                   echo '<tr>
                                                    <td align = "left">There are currently no registered donation.</td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
