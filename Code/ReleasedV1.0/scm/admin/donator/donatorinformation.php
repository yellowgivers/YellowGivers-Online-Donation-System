            ...
            <ul class="nav">
                ...
                <li><a data-toggle="collapse" href="#donator"><i class="pe-7s-users"></i><p>Donator<b class="caret"></b></p></a>
                    <div class="collapse" id="donator">
                        <ul class="nav">
                            <li>
                                <a href="/scm/admin/donation/donatorinformation.php"><i class="pe-7s-note2"></i><p>Donator Information</p></a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Donator Informations Details</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <thead>
                                        ...
                                        <th>Donator Email</th>
                                        <th>Donator Phone</th>
                                        <th>Donator Category</th>
                                        <th>Donator Donate</th>
                                    </thead>
                                    <tbody>
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    <td align = "left">'  .  $row['doAddress']  .  '</td>
                                                    <td align = "left">'  .  $row['doEmail']  .  '</td>
                                                    <td align = "left">'  .  $row['doPhone']  .  '</td>
                                                    <td align = "left">'  .  $row['doCategory']  .  '</td>
                                                    <td align = "left">'  .  $row['doDonate']  .  '</td>
                                                    </tr>
                                                    ';
                                            }
