            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Receiver Informations Details</h4>
                            </div>
                                    ...
                                    <tbody>
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                          echo '<tr>
                                                    <td align = "left">'  .  $row['reID']  .  '</td>
                                                    <td align = "left">'  .  $row['reNames']  .  '</td>
                                                    <td align = "left">'  .  $row['reAddress']  .  '</td>
                                                    <td align = "left">'  .  $row['reEmail']  .  '</td>
                                                    <td align = "left">'  .  $row['rePhone']  .  '</td>
                                                    <td align = "left">'  .  $row['reCategory']  .  '</td>
                                                    <td align = "center"><a href ="receiverupdate.php?id='  .  $row['reID']  .  '">Update</a></td>
                                                    <td align ="center"><a href ="receiverdelete.php?id='  .  $row['reID']  .  '">Delete</a></td>
                                                    </tr>
                                                    ';
                                            }
                                            ...
                                            mysqli_free_result ($result);
                                                  ...
                                                  echo '<p class = "error">  There are currently no registered company.</p>';
                                            }
