            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Yellow Givers Funds Informations Details</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <th>YL Fund ID</th>
                                        <th>YL Fund Category</th>
                                        <th>YL Fund Amount</th>
                                    </thead>
                                    <tbody>
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                        echo '<tr>
                                                            <td align = "left"></td>
                                                            <td align = "left">'  .  $row['funcat']  .  '</td>
                                                            <td align = "left">'  .  $row['funamount']  .  '</td>
                                                            </tr>
                                                        ';
                                                    }
                                            ...
                                            mysqli_free_result ($result);
                                                  ...
                                                  echo '<tr>
                                                            <td align = "left">There are currently no funding been made</td>
                                                            <td align = "left"></td>
                                                            <td align = "left"></td>
                                                            </tr>
                                                        ';
