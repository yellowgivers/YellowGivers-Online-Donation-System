...
<head>
	...
	<title>Delete Receiver Informations</title>
                            ...
                            <div class="content">
                                <form id="myFormId" action="receiverdelete.php" method="post">
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="reEmail" type="text" class="form-control" value="<?php echo $reNames; ?>" placeholder="Company Email" tabindex="1" >
                                            </div>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        $db = 'scmdb';
                                        $connect = mysqli_connect($hostname, $username, $password, $db );
                                        $query = "DELETE FROM receiver WHERE reID = '$id'";
                                        $result = mysqli_query($connect,$query);

                                        
                                        if (mysqli_affected_rows($connect) == 1) {

                                                echo '<h3 id ="mainhead">The company informations has been deleted</h3>';
