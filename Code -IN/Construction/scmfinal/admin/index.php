            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <strong><h2 class="title">Notifications</h2></strong>
                            </div>
                                        ...
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                        echo '<tr>
                                                            <td align = "left">'  .  $i  .  '</td>
                                                            <td align = "left">'  .  $row['noname']  .  '</td>
                                                            <td align = "left">'  .  $row['noemail']  .  '</td>
                                                            <td align = "left">'  .  $row['nosubject']  .  '</td>
                                                            <td align = "left">'  .  $row['nostatus']  .  '</td>
                                                            <td align = "left"><a href ="notification-read.php?id='  .  $row['noid']  .  '"><i class="fa fa-pencil"></a></td>
                                                            <td align ="left"><a href ="notification-delete.php?id='  .  $row['noid']  .  '"><i class="fa fa-trash-o"></a></td>
                                                            </tr>
                                                        ';
                                                        $i++;
                                                    }
                                            ...
                                            mysqli_free_result ($result);
                                                  ...
                                                  echo '<p class = "error"> </p>';
                                                   echo '<tr>
                                                    <td align = "left">There are currently no new notifications</td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
                                                    <td align = "left"></td>
