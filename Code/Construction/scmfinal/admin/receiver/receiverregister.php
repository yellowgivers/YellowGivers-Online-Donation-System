            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Donatary Registration</h4>
                            </div>
                            <div class="content">
                                <form id="myFormId" action="receiverregister.php" method="post" enctype='multipart/form-data'>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Donatary Name</label>
                                                <input id="1" name="donaname" type="text" class="form-control" placeholder="Donatary Name" tabindex="1" >
                                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaadd" type="text" class="form-control" placeholder="Donatary Address" tabindex="1" >
                                                <?php
                                                if (isset($_POST['submitted'])) {
                                                    $errors = array();
                                    ...
                                    <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaemail" type="text" class="form-control"  placeholder="Donatary Email" tabindex="1" >
                                                <?php
                                                if (isset($_POST['submitted'])) {
                                                    $errors = array();
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaphone" type="text" class="form-control" placeholder="Donatary Phone" tabindex="1" >
                                                <?php
                                                if (isset($_POST['submitted'])) {
                                                    $errors = array();
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label>Donatary Logo</label>
                                            <div class="input-group">
                                                <input id="3" type="text"  class="form-control" readonly>
                                                <label class="input-group-btn">
                                                    <span class="btn btn-primary">
                                                        Browse&hellip; <input type="file" name="donalogo"   style="display: none;" multiple>
                                                    </span>
                                                </label> 
                                                <?php
                                                if (isset($_POST['submitted'])) {
                                                    ...
                                                    //null value supplierName
                                                    if (empty($_FILES['donalogo'])) {
                                                        $errors[]='You forget to enter your donatary logo';
                                                    }else{
                                                        $don_logo = $_FILES['donalogo']['name'];
                                                        $don_logo_tmp = $_FILES['donalogo']['tmp_name'];
                                                        move_uploaded_file($don_logo_tmp,"images/$don_logo");
                                    ...
                                    <div>
                                        <button type="submit" name="submit" class="btn btn-info btn-fill pull-right">Register Donatary</button>
                                    ...
                                    <?php
                                        if (isset($_POST['submitted'])) {
                                            ...
                                            if(empty($errors)){
                                                ...
                                                $query = "INSERT INTO donatary (donaname, donaadd, donaemail, donaphone, donacat, donalogo) VALUES ('$donaname', '$donaadd', '$donaemail', '$donaphone', '$donacat', '$don_logo')";
                                                    $result = mysqli_query($connect,$query);
                                                    
                                                        
                                                    if ($result){
                                                            echo '<h3>Donatary Successfully Register !</h3>';
                                                            exit();
                                                    }
                                                }
