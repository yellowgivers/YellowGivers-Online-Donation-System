            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Delete Donatary Details</h4>
                            </div>
                            <div class="content">
                                <form id="myFormId" action="receiverdelete.php" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Donatary Name</label>
                                                <input id="1" name="donaname" type="text" class="form-control" value="<?php echo $donaname;?>" placeholder="Donatary Name" tabindex="1" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaadd" type="text" class="form-control" value="<?php echo $donaadd;?>" placeholder="Donatary Address" tabindex="1" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaemail" type="text" class="form-control" value="<?php echo $donaemail;?>" placeholder="Donatary Email" tabindex="1" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">   
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="1" name="donaphone" type="text" class="form-control" value="<?php echo $donaphone;?>" placeholder="Donatary Phone" tabindex="1" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="dropdown">
                                                    <select class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" name="donacat" disabled>
                                                      <option><?php echo $donacat;?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        $db = 'scmdb';
                                        $connect = mysqli_connect($hostname, $username, $password, $db );
                                        $query = "DELETE FROM donatary WHERE donaid = '$id'";
                                        $result = mysqli_query($connect,$query);

                                        
                                        if (mysqli_affected_rows($connect) == 1) {

                                                echo '<h3 id ="mainhead">The donatary informations has been deleted</h3>';
