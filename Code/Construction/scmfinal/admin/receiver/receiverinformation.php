            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Donatary Informations Details</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <th>Donatary ID</th>
                                        <th>Donatary Name</th>
                                    	<th>Donatary Address</th>
                                        <th>Donatary Email</th>
                                        <th>Donatary Phone</th>
                                        <th>Donatary Category</th>
                                        <th>Update</th>
                                        <th>Delete</th>
                                    </thead>
                                    <tbody>
                                        <?php
                                             //connect to database
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                        echo '<tr>
                                                            <td align = "left">'.$i.'</td>
                                                            <td align = "left">'  .  $row['donaname']  .  '</td>
                                                            <td align = "left">'  .  $row['donaadd']  .  '</td>
                                                            <td align = "left">'  .  $row['donaemail']  .  '</td>
                                                            <td align = "left">'  .  $row['donaphone']  .  '</td>
                                                            <td align = "left">'  .  $row['donacat']  .  '</td>
                                                            <td align = "center"><a href ="receiverupdate.php?id='  .  $row['donaid']  .  '"><i class="fa fa-pencil"></a></td>
                                                            <td align ="center"><a href ="receiverdelete.php?id='  .  $row['donaid']  .  '"><i class="fa fa-trash-o"></a></td>
                                                            </tr>
                                                        ';
                                                        $i ++;
                                                    }
                                            ...
                                            mysqli_free_result ($result);
                                                  ...
                                                  echo '<tr>
                                                            <td align = "left">There are currently no registered donatary.</td>
                                                            <td align = "left"></td>
                                                            <td align = "left"></td>
                                                            <td align = "left"></td>
                                                            <td align = "left"></td>
