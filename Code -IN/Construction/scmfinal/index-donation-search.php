                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="index-donation.php">Donation Category <span class="badge pull-right">
                                        <?php
                                             $hostname = 'localhost';
                                                $username = 'root';
                                                $password = '';
                                                ...
                                                $query = "SELECT DISTINCT doncat FROM donation";
                                    ...
                                    <ul>
                                       <?php
                                             //connect to database
                                                ...
                                                $query = "SELECT * FROM donation WHERE doncat = '$doncat'";
                                                $result = mysqli_query($connect,$query);
                                                $num = mysqli_num_rows ($result);
                                                ...
                                                if ($num > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                                                          echo ' <li><a href="index-donation-search.php?doncat='  .  urlencode($row['doncat'])  .  '">'  .  $row['doncat']  .  '</a></li>';
                                                      }

                                            mysqli_free_result ($result);

                                            }else{
                                                  echo '<p class = "error">There are currently no registered donation.</p>';
                                            }
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4 products-showing">
                                ...
                                <?php
                                    ...
                                    echo"$num";
                                ?>      
                                </strong><strong>donation available</strong>
                            </div>
                        </div>
                    </div>
                    <?php
                                        ...
                                        echo'<div class="product">';
                                            echo'<div class="flip-container">';
                                                echo'<div class="flipper">';
                                                    echo '<tr>
                                                            <td align = "center"><img src="/scmfinal/admin/donation/images/' . $row['donimage'] . '" alt="" style="width:250px; height:250px;"></td>
                                                            </tr>';
                                                echo'</div>';
                                            echo'</div>';
                                            echo'<a href="index-product-detail.html" class="invisible">';
                                            echo'</a>';
                                            echo'<div class="text">';
                                            echo'<h3><a href="#">'  .  $row['dondesc']  .  '</a></h3>';
                                            echo'<h3><a href="#">'  .  $row['doncat']  .  '</a></h3>';
                                                echo'<p class="buttons">';
                                                    echo'<a href ="index-donation-detail.php?id='  .  $row['donid']  .  '" class="btn btn-default">View detail</a>';                                 
                                                echo'</p>';
                                            echo'</div>';
                                        echo'</div>';
                                    echo'</div>';
